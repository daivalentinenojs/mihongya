        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; background-color: #fff !important; padding-top: 30px;">
            ...
            <tr>
                <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
                    <h1>{{__('email.customerMessageMail.dear')}}</h1>
                </td>
            </tr>
            <tr>
                <td valign="middle" class="hero">
                    <table>
                        <tr>
                            <td class="bg_dark email-section" style="text-align:center;">
                                <div class="heading-section heading-section-white">
                                    <h2><a href="{{__('company.social.website.url')}}" style="color: #06A3DA;">{{__('email.customerMessageMail.content.connected')}}</a></h2>
                                    <h2 style="color: #06A3DA;">{{__('email.customerMessageMail.content.customer')}}</h2>
                                    <p>                                        
                                        <b>{{__('email.customerMessageMail.content.name')}}</b> {{$request->name}} <br>
                                        <b>{{__('email.customerMessageMail.content.email')}}</b> {{$request->email}} <br>
                                        <b>{{__('email.customerMessageMail.content.phone')}}</b> {{$request->phone}}
                                    </p>                                    
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="bg_dark email-section" style="text-align:center;">
                                <div class="heading-section heading-section-white">
                                    <h2 style="color: #06A3DA !important;">{{$request->subject}}</h2>
                                    <p>"{{$request->message}}"
                                    </p>
                                </div>
                            </td>
