        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; background-color: #fff !important; padding-top: 30px;">
            <tr style="margin-top: 10px;">
                <td class="img">
                    <table>
                        <tr>
                            <td>
                                <img src="{{__('email.customerMessageThankYou.logoHeader')}}" width="600" height="" alt="{{__('email.customerMessageThankYou.alt.logoHeader')}}" border="0" style="width: 50%; max-width: 600px; height: auto; padding-top: 10px; margin: auto; display: block;" class="g-img">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
                    <h1>{{__('email.customerMessageThankYou.dear')}} {{$request->name}},</h1>
                </td>
            </tr>
            <tr>
                <td valign="middle" class="hero">
                    <table>
                        <tr>
                            <td class="bg_dark email-section" style="text-align:center;">
                                <div class="heading-section heading-section-white">
                                    <h2 style="color: #06A3DA;"><a href="{{__('company.social.website.url')}}" style="color: #06A3DA;">{{__('email.customerMessageThankYou.content.connected')}}</a></h2>
                                    <h2 style="color: #06A3DA;">{{__('email.customerMessageThankYou.content.yourMessage')}}</h2>
                                    <h2>"{{$request->message}}"
                                    </h2>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="bg_dark email-section" style="text-align:center;">
                                <div class="heading-section heading-section-white">
                                    <h2 style="color: #06A3DA;">{{__('email.customerMessageThankYou.content.contact')}}</h2>
                                    <p> {{__('email.customerMessageThankYou.content.sendMessage')}} <br>
                                        {{__('email.customerMessageThankYou.content.row1')}} <a href="{{__('company.social.instagram.url')}}">{{__('company.social.instagram.username')}}</a> <br>
                                        {{__('email.customerMessageThankYou.content.row2')}} <br> 
                                        {{__('email.customerMessageThankYou.content.row3')}} <br><br>
                                        {{__('email.customerMessageThankYou.content.touch')}} <br><br>
                                        {{__('email.customerMessageThankYou.content.note')}} 
                                    </p>
                                </div>
                            </td>
                        </tr>
