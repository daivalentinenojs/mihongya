...
@section('title')
    {{__('company.info.brand.title')}} | Profile
@endsection
        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <a class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade to Pro</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Info-->
                                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                    ...
                                    <!--end::Svg Icon-->{{ $user->address == '' ? 'Not Registered' : $user->address }}</a>
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5">Settings</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5">Security</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5">Billing</a>
                    </li>
                    <!--end::Nav item-->
                </ul>
                <!--begin::Navs-->
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <input name="firstname" required type="text" value="{{$user->firstname}}" class="form-control form-control-solid">
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                     ...
                     <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <input name="lastname" required type="text" value="{{$user->lastname}}" class="form-control form-control-solid">
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input name="email" required type="text" value="{{$user->email}}" class="form-control form-control-solid">
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <input name="phone" id="phone"
                                    ...
                                    type="text" value="{{$user->phone}}" class="input-phone form-control form-control-solid me-2">
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <input name="address" type="text" value="{{$user->address}}" class="form-control form-control-solid">
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
