...
@section('title')
    {{__('company.info.brand.title')}} | Master Data User
@endsection
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Add user-->
                            <button type="button" class="btn btn-primary" onclick="addUser()"  data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                        ...
                        <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <!--begin::Form-->
                                        <form id="kt_modal_add_user_form" class="form" action="{{ url()->current() }}" method="post">
                                            @csrf
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="email" name="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="daiva@mail.com"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="phone" minlength="7" maxlength="10"
                                                        onkeypress="return IsNumeric(event)"  
                                                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder="0971688452"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Kunyang Street 372"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                        ...
                                        <a href="../../demo1/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <?php
                                                    ...
                                                    $imagePath = "assets/user/media/avatars/300-$randomNumber.jpg";
                                                ?>
                                                <img src="{{asset($imagePath)}}" alt="{{ $u->firstname }} {{ $u->lastname }}" class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $u->firstname }} {{ $u->lastname }}</a>
                                        <span>{{ $u->email }}</span>
                                    </div>
                                    <!--begin::User details-->
                                </td>
                                ...
                                <!--begin::Last login=-->
                                <td>
                                    <div class="badge badge-light fw-bolder">{{ $u->phone }}</div>
                                </td>
                                <!--end::Last login=-->
                                <!--begin::Joined-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a onclick="editUser({{ $u->id }})" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a onclick="deleteUser({{ $u->id }})" class="menu-link px-3">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
...
<script>
    function addUser(userId) {
        // Change Title
        const modalTitleElement = document.querySelector('#kt_modal_add_user_header h2');
        modalTitleElement.textContent = 'Add User';

        // Get the form element
        const formElement = document.getElementById('kt_modal_add_user_form');
        const addActionUrl = `/{{ app()->getLocale() }}/admin/master-data/user`; 
        formElement.action = addActionUrl;
    }
    ...
    function getUserDataById(userId) {
        $.ajax({
            url: `/{{ app()->getLocale() }}/admin/master-data/user/${userId}`,
            type: 'GET',
            headers: {
            ...
            success: function(response) {
                ...
                // Change Title
                const modalTitleElement = document.querySelector('#kt_modal_add_user_header h2');
                modalTitleElement.textContent = 'Edit User';

                // Get the form element
                const formElement = document.getElementById('kt_modal_add_user_form');
                const addActionUrl = `/{{ app()->getLocale() }}/admin/master-data/user/${userId}`; 
                formElement.action = addActionUrl;
    ...
    function deleteUser(userId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Send an AJAX request to delete the user with ID 'userId'
                $.ajax({
                    url: `/{{ app()->getLocale() }}/admin/master-data/user/${userId}`,
                    type: 'DELETE',
                    headers: {
